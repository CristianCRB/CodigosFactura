...
uses
  ...
  cxLookAndFeelPainters, cxClasses, dxCustomTileControl, dxTileControl,
  ...
  Vcl.DBGrids, Datasnap.DBClient, UNTmenuprincipal;
...
begin
  ...
  begin
    ...
    AItem.Text3.Value := ds.FieldByName('CODIGO').AsString;
